...
-   **NFR-PERF-001**: p95 TTFB for [endpoint/page] ≤ [budget] ms under [conditions]; queries ≤ [limit], no N+1.
-   **NFR-TEST-001**: Add/modify tests to maintain ≥ 80% coverage (≥ 90% for critical flows) and determinism.
